                ...
                <div className='flex-1'>
                  <div className='flex items-center justify-between'>
                    ...
                    <div className='flex gap-2 items-center'>
                      <button className='btn btn-info btn-xs'><MdEdit /></button>
                      <button className='btn btn-ghost'><ImCross /></button>
                    </div>
                  </div>
                  ...
                  <div className='flex-1 py-5 mt-5 flex flex-col gap-2'>
                    <div className='flex items-center justify-between'><p>email:</p><p>{user?.email}</p></div>
                    <div className='flex items-center justify-between'><p>grade:</p><p>{user?.grade}</p></div>
                    <div className='flex items-center justify-between'><p>ID:</p><p>{user?._id}</p></div>
                  </div>
                </div>
